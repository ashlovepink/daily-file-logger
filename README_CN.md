...
总是想回看当天的日记的时候, 回想那一天发生了什么, 我真的很想回忆起某一天到底写了哪些笔记, 记录了什么, 是不是深夜还在打开某篇笔记继续发散思维? 又或者深夜突发奇想创建了某篇笔记呢?

现有的插件库里找了一圈也没发现能实现的, 想想不如就自己来写一个好了. 使用的是 GROK3 模型来帮助完成代码的部分.

可以在回溯当天日记的时候知道当天到底创建了什么笔记, 编辑了什么笔记, 时间分别是多少;

也可以在写当天日记的时候一目了然的看到当天的状况, 也是帮助好好写日记的一种方法吧. 
